...
function ERP() {
    ...
    const PropsForFirstPage = {
        Pageheader: "ERP Solutions",
        imgSrc: "4",
        heading:
          "Need Easy ERP Solution For Your Company? ",
      ...
      const PropsForSecondPage = {
        ...
        Header: "Top ERP Development Company",
        ParaTwo:
    ...
    const PropsForThirdPage = ["Barcode","Labeling","Medical","Salon","Inventory","Salary", "StaffManagement","Attendence",     ]
